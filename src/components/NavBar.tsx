...
const NAV_LINKS = [
  ...
  { label: "Contact Us", href: "https://api.whatsapp.com/send?phone=919863624632&text=Hi%20StartTambola%20team!%20I%20have%20a%20question." },
];
    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-dark-bg">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          {isSimpleMode && (
            <a 
              href="https://api.whatsapp.com/send?phone=919863624632&text=Hi%20StartTambola%20team!%20I%20have%20a%20question." 
              target="_blank" 
              rel="noreferrer" 
