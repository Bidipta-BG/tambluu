      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li><a href="https://api.whatsapp.com/send?phone=96096914772&text=Hi%20StartTambola%20team!%20I%20have%20a%20question." target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Contact Us</a></li>
          </ul>
        </div>
      </div>
